...
import static org.eclipse.edc.identityhub.api.IssuerAdminApiAuthenticationExtension.NAME;

@Extension(NAME)
public class IssuerAdminApiAuthenticationExtension implements ServiceExtension {

    public static final String NAME = "Issuer Admin API Authentication Extension";
    @Inject
