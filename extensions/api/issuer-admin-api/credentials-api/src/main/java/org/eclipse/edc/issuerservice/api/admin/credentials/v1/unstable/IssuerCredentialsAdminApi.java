...
public interface IssuerCredentialsAdminApi {
    ...
    VerifiableCredentialResponse getAllCredentials(String participantId);
    ...
    @Operation(description = "Revokes a credential with the given ID for the given participant. Revoked credentials will be added to the Revocation List",
            ...
            parameters = {
                    @Parameter(name = "participantId", description = "ID of the participant whos credential should be revoked", required = true, in = ParameterIn.PATH),
    ...
    Response revokeCredential(String participantId, String credentialId);
    ...
    @Operation(description = "Suspends a credential with the given ID for the given participant. Suspended credentials will be added to the Revocation List. Suspension is reversible.",
            ...
            parameters = {
                    @Parameter(name = "participantId", description = "ID of the participant whos credential should be suspended", required = true, in = ParameterIn.PATH),
                    @Parameter(name = "credentialId", description = "ID of the credential to revoke", required = true, in = ParameterIn.PATH)
            },
            responses = {
    ...
    Response suspendCredential(String participantId, String credentialId);
    ...
    @Operation(description = "Resumes a credential with the given ID for the given participant. Resumed credentials will be removed from the Revocation List.",
            ...
            parameters = {
                    @Parameter(name = "participantId", description = "ID of the participant whos credential should be resumed", required = true, in = ParameterIn.PATH),
    ...
    Response resumeCredential(String participantId, String credentialId);
    ...
    @Operation(description = "Checks the revocation status of a credential with the given ID for the given participant.",
            ...
            parameters = {
                    @Parameter(name = "participantId", description = "ID of the participant whos credential should be checked", required = true, in = ParameterIn.PATH),
