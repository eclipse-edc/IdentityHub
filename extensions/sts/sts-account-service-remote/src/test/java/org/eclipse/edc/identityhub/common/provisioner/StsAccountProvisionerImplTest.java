...
class StsAccountProvisionerImplTest {
    ...
    private final StsAccountProvisionerImpl accountProvisioner = new StsAccountProvisionerImpl(monitor, vault, stsClientSecretGenerator, new LocalStsAccountService(stsAccountStore, new NoopTransactionContext()));
