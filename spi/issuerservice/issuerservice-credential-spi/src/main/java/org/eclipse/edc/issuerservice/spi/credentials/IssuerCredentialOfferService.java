...
public interface IssuerCredentialOfferService {
     ...
     * @param credentialDescriptor a descriptor containing a format identifier, a credentialType and an offer reason
     * @return a result to indicate whether the {@code CredentialOfferMessage} was sent successfully.
     */
    ServiceResult<Void> sendCredentialOffer(String participantContextId, String holderId, Collection<CredentialDescriptor> credentialDescriptor);
}
