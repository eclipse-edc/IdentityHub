...
class IssuerCredentialOfferServiceImplTest {
    ...
    void sendCredentialOffer_usesRequestedOfferReason() {
        ...
        var messageCaptor = ArgumentCaptor.forClass(CredentialOfferMessage.class);
        ...
        Assertions.assertThat(messageCaptor.getValue().getCredentials())
                .allSatisfy(co -> Assertions.assertThat(co.getOfferReason()).isEqualTo(OFFER_REASON_PROOF_KEY_REVOCATION));
    }
    ...
    void sendCredentialOffer_credentialObjectNotExists() {
        var result = credentialOfferService.sendCredentialOffer(PARTICIPANT_CONTEXT_ID, HOLDER_ID, List.of("not-exist"), null);
    ...
    private IdentityHubParticipantContext issuerParticipant() {
